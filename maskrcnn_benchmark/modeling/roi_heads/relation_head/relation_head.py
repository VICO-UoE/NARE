...
class ROIRelationHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None, loss_samples=None, logger=None):
        """
        Arguments:
        ...
        if self.two_heads:
            ...
            loss_relation, loss_refine = self.loss_evaluator(proposals, rel_labels, relation_logits,mixed_relation_logits,lam, idx, loss_samples, refine_logits)
