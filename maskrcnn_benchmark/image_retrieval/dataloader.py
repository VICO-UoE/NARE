...
class SGEncoding(data.Dataset):
    ...
    def __init__(self, train_ids, test_ids, sg_data, test_on=False, val_on=False, num_test=5000, num_val=5000):
        ...
        cap_graph = json.load(open('/raid/s1985335/scene-graph-benchmark/datasets/vg/vg_capgraphs_anno.json'))
        vg_dict = json.load(open('/raid/s1985335/scene-graph-benchmark/datasets/vg/VG-SGG-dicts-with-attri.json'))
