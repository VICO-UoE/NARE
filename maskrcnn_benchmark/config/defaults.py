...
_C.MODEL.ROI_RELATION_HEAD.TWO_HEADS = False
_C.MODEL.ROI_RELATION_HEAD.PME_SOFTMAX_LOSS = False
_C.MODEL.ROI_RELATION_HEAD.BCE_TEMP_LOSS = False
_C.MODEL.ROI_RELATION_HEAD.SELF_TRAIN_LOSS = 'none'
_C.MODEL.ROI_RELATION_HEAD.MANIFOLD_MIXUP = False
_C.MODEL.ROI_RELATION_HEAD.IMP_MANIFOLD_MIXUP = False
_C.MODEL.ROI_RELATION_HEAD.SOFT_LABELS = False
